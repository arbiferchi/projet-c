...
pkgdatadir = $(datadir)/arbi
pkgincludedir = $(includedir)/arbi
pkglibdir = $(libdir)/arbi
pkglibexecdir = $(libexecdir)/arbi
...
am_arbi_OBJECTS = main.$(OBJEXT) support.$(OBJEXT) interface.$(OBJEXT) \
	callbacks.$(OBJEXT) etudiant.$(OBJEXT)
arbi_OBJECTS = $(am_arbi_OBJECTS)
am__DEPENDENCIES_1 =
arbi_DEPENDENCIES = $(am__DEPENDENCIES_1)
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(arbi_SOURCES)
DIST_SOURCES = $(arbi_SOURCES)
...
ACLOCAL = ${SHELL} "/home/arbi/Desktop/arbi (1)/missing" aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} "/home/arbi/Desktop/arbi (1)/missing" autoconf
AUTOHEADER = ${SHELL} "/home/arbi/Desktop/arbi (1)/missing" autoheader
AUTOMAKE = ${SHELL} "/home/arbi/Desktop/arbi (1)/missing" automake-1.15
AWK = mawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} "/home/arbi/Desktop/arbi (1)/missing" makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/arbi/Desktop/arbi (1)/src
abs_srcdir = /home/arbi/Desktop/arbi (1)/src
abs_top_builddir = /home/arbi/Desktop/arbi (1)
abs_top_srcdir = /home/arbi/Desktop/arbi (1)
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} '/home/arbi/Desktop/arbi (1)/install-sh'
...
arbi_LDADD = -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lfontconfig -lfreetype $(INTLLIBS)
all: all-am
...
arbi$(EXEEXT): $(arbi_OBJECTS) $(arbi_DEPENDENCIES) $(EXTRA_arbi_DEPENDENCIES) 
	@rm -f arbi$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(arbi_OBJECTS) $(arbi_LDADD) $(LIBS)
